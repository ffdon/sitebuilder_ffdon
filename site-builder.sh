...
# f체r mehrere Hardware-Architekturen
# f체r mehrere Dom채nen
# 
###############################################################################################
# Buildscript zur Erstellung der Images
# 
# Dieses Script holt die passende Gluon-Version von GitHub und 체bertr채gt die Gluon-Konfiguration
#
###############################################################################################
...
#echo $BUILD_STRING
## F체r die Bracnches  stable und experimental gibt es die Autoupdate-Funktion, 
#GLUON_BRANCH="stable"
...
#echo ###################################################
#echo ***************************************************
#echo *** wir w체rden jetzt $Domaene $Arch Kompilieren ***
#echo ***************************************************
#echo ###################################################
